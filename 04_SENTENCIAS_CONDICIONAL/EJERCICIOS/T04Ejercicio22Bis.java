...
public class T04Ejercicio22Bis {
    public static void main(String[] args) {
        ...
        int minutosTotal = (horaFinal*60)+minutosFinal;

        System.out.printf("¡Te quedan %d horas y %d minutos para el fin de semana!\n", horaFinal, minutosFinal);
        System.out.println("En total serían " + minutosTotal + " minutos.");
    }
}
